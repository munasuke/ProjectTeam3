...
#else
				DissolveVertex2Fragment(IN.texcoord, IN.texcoord1, OUT.dissolveUV);
#endif
...
#ifdef _DISSOLVETRIPLANAR_ON
				float alpha = ReadDissolveAlpha_Triplanar(IN.coords, IN.objNormal, IN.worldPosition);
#else
				float alpha = ReadDissolveAlpha(IN.texcoord.xy, IN.dissolveUV, IN.worldPosition);
#endif				
